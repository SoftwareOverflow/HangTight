...
public class SharedPreferenceHelper {
    ...
    public static String getSavedSoundName(@NonNull  SharedPreferences preferences) {
    ...
    public static boolean getShowWarmUpWarning(Context context,  SharedPreferences preferences){
        return preferences.getBoolean("showWarmUp", true);
    }
}
