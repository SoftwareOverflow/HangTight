...
public class SaveWorkoutDialog extends AlertDialog
    ...
    public SaveWorkoutDialog(Context context, Workout workout) {
        ...
        setTitle(context.getString(R.string.save_workout));
        ...
        setButton(BUTTON_POSITIVE, context.getString(R.string.save_workout), (OnClickListener) null);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        if(isChecked){
            ...
            saveNew.setAlpha(0.6f);
        } else {
            overwriteExisting.setAlpha(0.6f);
            saveNew.setAlpha(1f);
        }
    }
    ...
    private void handleResult(boolean success){
        if(success){
            ...
            Snackbar.make(rootView, context.getString(R.string.workout_saved), Snackbar.LENGTH_SHORT).show();
    ...
    private void logToFirebase(){
        ...
        firebaseAnalytics.logEvent("workout_saved", null);
    }
}
